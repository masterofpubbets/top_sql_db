...
,[Subsystem description],[Resp.],
[TP SCP],[TP ACT],[TP % COMPLETED],[RST SCP],[RST ACT],[RST % COMPLETED],[EQ SCP],[EQ ACT],[EQ % COMPLETED],[CL SCP],[CL ACT],[CL % COMPLETED],
[CT SCP],[CT ACT],[CT % COMPLETED],[CE SCP],[CE ACT],[CE % COMPLETED]
,[INS SCP],[INS ACT],[INS % COMPLETED],[HK SCP],[HK ACT],[HK % COMPLETED],[SI SCP],[SI ACT],[SI % COMPLETED],
Issues,[Responsible]
...
(
	SUM(dataValue)
	FOR Discipline IN ([HT SCOPE],[HT ACTUAL],[REINSTATED SCOPE],[REINSTATED ACTUAL],[EQUIPMENT SCOPE],[EQUIPMENT ACTUAL],[CABLE LAYING SCOPE (NO)],[CABLE LAYING ACTUAL (NO)],[CABLE TERMINATION SCOPE (NO)],[CABLE TERMINATION ACTUAL (NO)],[CABLE ENDS SCOPE (NO)],[CABLE ENDS ACTUAL (NO)],[INSTRUMENT SCOPE],[INSTRUMENT ACTUAL],[HOOKUP SCOPE],[HOOKUP ACTUAL],[Signal SCOPE],[Signal ACTUAL])
) p
) as vAllItems
--END MAIN ITEMS
) as vItems
...
GO
>>>>>>> 4fb7691d547ca94409f800b01e704608a1ce5c51
