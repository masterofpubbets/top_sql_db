ALTER PROC PIPING.GetWeldingMapStaging
AS
SELECT
Id
,CASE WHEN ValidateStatus IS NULL THEN 'Accepted' ELSE ValidateStatus END AS [Validate Status]
,[ValidateError]
...
,CASE WHEN [JoinName] IS NULL 
    THEN [Plant] + [Unit] + [System] + [Subsystem] + [EquipmentCode] + [BranchNumber] + [Train] + [Spool] + [JointNumber] 
ELSE
    [Plant] + [Unit] + [System] + [Subsystem] + [EquipmentCode] + [BranchNumber] + [Train] + [Spool] + [JointNumber] + [JoinName]
END AS [Joint Key]
