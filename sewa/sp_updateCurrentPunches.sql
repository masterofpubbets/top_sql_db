...
UPDATE v
SET 
--v.[Current punchDiscId] = v.punchDiscId
v.[Current punchCatId] = v.punchCatId
--,v.[Current subconId] = v.subconId
--,v.[Current punchBlock] = v.punchBlock
--,v.[Current punchDes] = v.punchDes
